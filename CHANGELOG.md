...
### Added
- Daemon subcommand group (start/stop/restart/status)

### Fixed
- Only include priority docs for project-level capsule queries
- Use DbResult consistently in annotations module

### Changed
- Improve README clarity and accuracy
- Add benchmark results and usage guidance to README

## [0.2.0] - 2026-03-06

### Changed
- Multiple dependency bumps (tree-sitter, crossterm, toml, tracing-opentelemetry)
...
[Unreleased]: https://github.com/Dalot/scavenger/compare/v0.2.2...HEAD
[0.2.2]: https://github.com/Dalot/scavenger/compare/v0.2.0...v0.2.2
[0.2.0]: https://github.com/Dalot/scavenger/compare/v0.1.1...v0.2.0
